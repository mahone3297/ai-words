...
## Example Sentences
- **Noun**: The marathon runner felt the strain in their legs as they approached the finish line.
- **Verb**: She strained her ears to catch the whispered conversation.
- **Adjective**: The old bridge was showing signs of strain from heavy traffic.
- **Adverb**: He strained every ounce of energy to complete the project on time.

## Synonyms
- Strain (noun): Tension, stress, effort, exertion
- Strain (verb): Exert, stretch, push, struggle
- Strained (adjective): Tense, stressed, strained-out, overtaxed
- Straining (adverb): Heavily, strenuously, with effort
